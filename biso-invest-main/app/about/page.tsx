...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-zinc-950 pb-24">
      <div className="bg-white dark:bg-zinc-900 border-b border-gray-100 dark:border-zinc-800 p-4 flex items-center justify-between sticky top-0 z-40">
        <Link href="/profile" className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-zinc-800">
          <ArrowLeft className="w-5 h-5 text-gray-700 dark:text-zinc-400" />
        </Link>
        <h1 className="font-bold text-gray-800 dark:text-zinc-200 text-sm">À propos</h1>
        <div className="w-9"></div>
      </div>

      <div className="max-w-3xl mx-auto p-6 space-y-6">
        <div className="bg-white dark:bg-zinc-900 rounded-2xl p-6 border border-gray-100 dark:border-zinc-800 shadow-xs space-y-4 leading-relaxed text-sm text-gray-700 dark:text-zinc-300">
          <div className="text-center pb-4 border-b border-gray-100 dark:border-zinc-800">
            <h2 className="text-2xl font-extrabold text-gray-900 dark:text-zinc-50 tracking-tight">BISO INVEST</h2>
          ...
          <div className="pt-4 border-t border-gray-100 dark:border-zinc-800 text-center">
            <p className="font-bold text-gray-900 dark:text-zinc-50">BISO INVEST</p>
            <p className="text-xs text-gray-500 dark:text-zinc-500">Ensemble, construisons demain.</p>
          </div>
        </div>
      </div>
    </div>
