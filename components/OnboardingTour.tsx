...
const STEPS: OnboardingStep[] = [
  ...
  },
  {
    ...
    description: 'Chaque jour, votre revenu mensuel est réparti selon les jours réels du mois (28, 29, 30 ou 31). Cliquez sur le bouton VENDRE chaque jour pour récupérer votre bénéfice — attention, un bénéfice non réclamé est perdu, il ne se reporte jamais.',
    icon: HandCoins,
    color: 'bg-teal-500',
  },
  {
