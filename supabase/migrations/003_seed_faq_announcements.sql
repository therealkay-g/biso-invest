...
values
  ...
  ('Comment fonctionnent les versements ?', 'Chaque investissement verse 10 % du capital investi par jour pendant 3 mois. Le bénéfice du jour doit être vendu chaque jour ; un jour non réclamé est perdu et n''est jamais reporté.', 5),
  ('Comment retirer ?', 'Enregistrez votre compte de retrait dans vos paramètres, puis rendez-vous sur Retirer. Le minimum est de 5 000 FC et des frais de 15 % s’appliquent sur le montant demandé.', 6),
  ...
  ('Comment fonctionne l’équipe ?', 'Partagez votre code de parrainage. Chaque invite qui investit valide 3 000 FC, puis des bonus automatiques sont crédités à 5, 10, 20, 50 et 100 invitations valides.', 9),
