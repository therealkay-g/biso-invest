...
values
  ...
  ('Comment fonctionnent les versements ?', 'Chaque investissement génère 12 échéances mensuelles prévues. Les versements sont crédités régulièrement sur votre wallet.', 5),
  ('Comment retirer ?', 'Enregistrez votre compte de retrait dans vos paramètres, puis rendez-vous sur Retirer. Le minimum est de 30 000 FC avec 0% de frais.', 6),
  ('Quel est le minimum de retrait ?', 'Le montant minimum de retrait est fixé à 30 000 FC.', 7),
